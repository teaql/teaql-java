...
public class Dm8IntegrationTest {
    ...
    public static void setup() throws Exception {
        // Use local dm8 instance running on port 5236
        ...
        taskDescriptor.setDataService("dm8");
        ...
        io.teaql.core.dm8.Dm8DataServiceExecutor dmExecutor = new io.teaql.core.dm8.Dm8DataServiceExecutor("dm8", jdbcSqlExecutor);
        ...
        try {
            jdbcSqlExecutor.execute("DROP TABLE task_data");
        } catch (Exception e) {}
        try {
            jdbcSqlExecutor.execute("DROP TABLE teaql_id_space");
        } catch (Exception e) {}

        // Ensure Schema
        dmExecutor.ensureSchema(ctx);
    }
