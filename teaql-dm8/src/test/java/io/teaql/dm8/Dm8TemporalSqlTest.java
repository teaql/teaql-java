...
public class Dm8TemporalSqlTest {
    @Test public void preparedAndDiagnosticSqlAreEquivalent() throws Exception {
        String url=System.getenv("TEAQL_TEST_DM8_URL"), user=System.getenv("TEAQL_TEST_DM8_USER"), password=System.getenv("TEAQL_TEST_DM8_PASSWORD");
        ...
        try(Connection c=DriverManager.getConnection(url,user,password)) {
            ...
            run(c,SqlDataServiceExecutor.debugSql(sql,v,"dm8").replaceFirst("VALUES \\(1,","VALUES (2,")); assertRows(c); drop(c);
        }
    }
