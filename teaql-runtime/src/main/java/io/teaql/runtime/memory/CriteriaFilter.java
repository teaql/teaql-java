...
public class CriteriaFilter<T extends Entity> implements Filter<T> {
    ...
    public boolean accept(T entity, SearchCriteria searchCriteria) {
        ...
        throw new TeaQLRuntimeException("unsupported searchCriteria:" + searchCriteria);
    }
    ...
    public boolean between(T entity, Between between) {
        ...
        if (!(first instanceof PropertyReference)) {
            throw new TeaQLRuntimeException("unsupported Between, first element is not PropertyReference");
        }

        if (!(second instanceof Parameter)) {
            throw new TeaQLRuntimeException("unsupported Between, second element is not Parameter");
        }

        if (!(third instanceof Parameter)) {
            throw new TeaQLRuntimeException("unsupported Between, third element is not Parameter");
        }
    ...
    public boolean twoOperatorCriteria(T entity, TwoOperatorCriteria twoOperatorsCriteria) {
        ...
        if (!(second instanceof Parameter)) {
            throw new TeaQLRuntimeException("unsupported twoOperatorCriteria, second element is not Parameter");
        }
        ...
        switch (((Operator) operator)) {
            ...
            case IN, IN_LARGE -> {
                if (ArrayUtil.isArray(value)) {
                    ...
                    for (int i = 0; i < length; i++) {
                        ...
                        compare = ObjectUtil.compare((Comparable) propertyValue, (Comparable) o);
                        if (compare == 0) {
                            return true;
                        }
                    }
                ...
                throw new TeaQLRuntimeException("operator in/in large should have the array parameter");
            }
            case NOT_IN, NOT_IN_LARGE -> {
                ...
                throw new TeaQLRuntimeException("operator not in/not in large should have the array parameter");
            }
        }
        return false;
    }
    ...
    public boolean oneOperatorCriteria(T entity, OneOperatorCriteria oneOperatorCriteria) {
        ...
        if (!(firstExpression instanceof PropertyReference)) {
            throw new TeaQLRuntimeException("PropertyReference is expected in oneOperatorCriteria:" + operator);
        }
        ...
        throw new TeaQLRuntimeException("unsupported operator in oneOperatorCriteria:" + operator);
    }
    ...
    public boolean not(T entity, NOT not) {
        ...
        for (Expression expression : expressions) {
            if (expression instanceof SearchCriteria sub) {
                ...
                throw new TeaQLRuntimeException("unexpected search criteria in not:" + expression);
            }
        }
        return false;
    }
    ...
    public boolean or(T entity, OR or) {
        ...
        for (Expression expression : expressions) {
            if (expression instanceof SearchCriteria sub) {
                ...
                throw new TeaQLRuntimeException("unexpected search criteria in or:" + expression);
            }
        }
        return false;
    }
    ...
    public boolean and(T entity, AND and) {
        ...
        for (Expression expression : expressions) {
            if (expression instanceof SearchCriteria sub) {
                ...
                throw new TeaQLRuntimeException("unexpected search criteria in and:" + expression);
            }
        }
        return true;
    }
