...
public class SqlAstCompiler {
    ...
    public String buildDataSQL(
        ...
        try {
            ...
            // conditions
            String whereSql = prepareCondition(repository, userContext, idTable, request.getSearchCriteria(), parameters);
    ...
    private String prepareCondition(SqlCompilerDelegate repository, UserContext userContext, String idTable, SearchCriteria criteria, Map<String, Object> parameters) {
        if (criteria == null) return SearchCriteria.TRUE;
        return ExpressionHelper.toSql(userContext, criteria, idTable, parameters, repository);
    }
